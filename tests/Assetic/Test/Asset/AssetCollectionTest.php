...
class AssetCollectionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testBrowseTree()
    {
        ...
        $asset2 = new FileAsset(__DIR__.'/../Fixture/browsetree/view');
        $asset3 = new FileAsset(__DIR__.'/../Fixture/browsetree/view/show.js');
        $asset4 = new FileAsset(__DIR__.'/../Fixture/browsetree/view/bar/show.js');

        $coll = new AssetCollection(array($asset1, $asset2, $asset3, $asset4));
        $coll->load();
